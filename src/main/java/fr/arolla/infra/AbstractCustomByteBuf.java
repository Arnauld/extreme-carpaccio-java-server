 ...
 */
public abstract class AbstractCustomByteBuf extends ByteBuf {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(AbstractCustomByteBuf.class);
    ...
    protected AbstractCustomByteBuf(int maxCapacity) {
        if (maxCapacity < 0) {
