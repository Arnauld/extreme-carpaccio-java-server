...
public class CustomByteBuf extends AbstractCustomByteBuf {
    ...
    public CustomByteBuf() {
        this(ByteBufAllocator.DEFAULT,1000,256*1000);
    }

    public CustomByteBuf(ByteBufAllocator alloc, int initialCapacity, int maxCapacity) {
        super(maxCapacity);
        if (alloc == null) {
     ...
     */
    protected CustomByteBuf(ByteBufAllocator alloc, ByteBuffer initialBuffer, int maxCapacity) {
        super(maxCapacity);
        if (alloc == null) {
            throw new NullPointerException("alloc");
        }
    ...
    public ByteBuf readBytes(byte[] dst, int dstIndex, int length) {
        ...
        System.out.println("XXXX___PLOP___XXXX");
